...
export const UpdatEmployees = ({ selectedDataRow,closeModalEdit }) => {
    ...
    const handleUpdate = async () => {
        ...
        if (data._statusId === '' || data.userEmail === '' || data.userFirstName === '' || data.userLastName === '' || data.userApplication === ''|| data.userPassword === '') {
            handleShowError();
            return;
        }
